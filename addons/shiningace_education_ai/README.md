...
- Every model inheriting `education.abstract.mixin` (shiningace_education_core,
  shiningace_education_curriculum, shiningace_education_content, shiningace_education_course) carries
